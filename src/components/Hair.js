...
function Hair() {
  ...
  return(
    ...
    <div className="clearfix"></div>
      ...
      <div className="styling-div"><p className="styling-div-title">Hair styling</p>
      ...
      <div className="coloring-div"><p className="coloring-div-title">Hair coloring</p>
      ...
      <div className="treatment-div"><p className="treatment-div-title">Hair treatment</p>
