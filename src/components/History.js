      ...
      <div className="flex-history">
        <div className="container-who">
          ...
          <div className="text_container">
            <p>Alex and Eve met in the early 80's in London and soon became close friends. Both college students at that time shared a mutual passion for the fashion industry so they experimented a lot with crazy outfits and wild hair a new way to reinvent themselves.</p><br></br>
        ...
        <div className="container-when">
          ...
          <div className="text_container">
            <p className="textRight">Their vision became reality in 1989 when the hairdresser opened for the first time and welcomed their customers in a firnedly and cozy flat. In 1991, since the number of customers continued to grow rapidly the owners made the decision to move from the original place and relocated their business to a new building in the center of London.</p>
          </div>
        </div>
        ...
        <div className="container-idea">
          ...
          <div className="text_container">
            <p className="textRight">Alex and Eve put themselves into their craft. Style and beauty is a form at art. Amadeus as a concept expands beyond it, embracing self-expression and uniqueness...</p>
          </div>
        </div>
      </div>  
